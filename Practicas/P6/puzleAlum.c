...
int buscarfila(int valor,tEstado *objetivo)
{
    int i,j;
    for(i = 0 ; i < N ; i++)
    {
...
int buscarcol(int valor,tEstado *objetivo)
{
    int i,j;
    for(i = 0 ; i < N ; i++)
    {
...
//AÑADIDO P6
int heuristicaDistanciaManhattan (tEstado *estado, tEstado *objetivo)
{
    int i,j,valor,filareal,colreal,iaux,jaux,sum = 0;
    ...
    for(i = 0 ; i < N ; i++)
    {
        ...
        {   
            ...
            {
                valor = estado->celdas[i][j];
                filareal = buscarfila(valor,objetivo);
                colreal = buscarcol(valor,objetivo);
                iaux = i;
                jaux = j;
                while(jaux != colreal || iaux != filareal)
                {
                    if(jaux > colreal)
                    {
                        jaux--;
